  ...
  return (
    <Layout>
      ...
      <div className="onas-baner">
        ...
        <div className="slider-2" style={{ backgroundImage: `url(${require('../images/V-max-HIFU-ekfety-1.jpeg')})` }}></div>
        <div className="slider-3" style={{ backgroundImage: `url(${require('../images/IPL-przebarwienia.jpg')})` }}></div>
      </div>
